...
CC = h5cc
CFLAGS = -fopenmp -std=c99 -I/usr/include -w
LDFLAGS = -lm -g
...
SRC2=img_renderer.c GRmath.c integrator.c metric.c plasma.c radiative_transfer.c raptor_harm3d_model.c RCARRY.c tetrad.c utilities.c geometry.c coordinates.c
OBJ2=img_renderer.o GRmath.o integrator.o metric.o plasma.o radiative_transfer.o raptor_harm3d_model.o RCARRY.o tetrad.o utilities.o geometry.o coordinates.o
